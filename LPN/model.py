...
class PoseResNet(nn.Module):
    ...
    def __init__(self, block, layers, USE_GCB):
        self.inplanes = 64
        # extra = cfg.MODEL.EXTRA
        self.deconv_with_bias = False  # extra.DECONV_WITH_BIAS
        self.use_gcb = USE_GCB  # extra.USE_GCB
        ...
        self.final_layer = nn.Conv2d(
            ...
            out_channels=16,  # cfg.MODEL.NUM_JOINTS,
...
def get_lpn(num_layers, use_gcb):
    block_class, layers = resnet_spec[num_layers]
    model = PoseResNet(block_class, layers, use_gcb)
    return model